...
//       try {
//         const response = await axios.get("https://footballbkd.onrender.com/api/football/leagues");
...
//           axios.get("imort/football/livescores"),
//           axios.get("https://footballbkd.onrender.com/api/football/fixtures")
//         ]);
...
//             country: 'us',
//             max: 10,
//             apikey: '5eed3c7f648610ff6e1c1d92be607d30', // Consider moving API keys to .env files
//           },
//         });
...
//                       match={card}
//                       teams={teams}
//                       leagues={footballLeagues} // Pass the correct footballLeagues state
